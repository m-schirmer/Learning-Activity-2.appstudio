...
const cacheName = 'Learning_Activity_2-2021-09-15 15:57:55.061327'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Learning_Activity_2'.length) === 'Learning_Activity_2') {
